module "cd-processor-service" {
  ...
  env_from = [
    ...
    { type = "configmap", name = duplocloud_k8_config_map.kibana.name },
    { type = "configmap", name = duplocloud_k8_config_map.ambassador-gateway.name },
